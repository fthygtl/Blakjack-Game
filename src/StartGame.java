...
public class StartGame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1124, 868));
        setMinimumSize(new java.awt.Dimension(924, 668));
        setResizable(false);
        ...
        allInButton.setBackground(new java.awt.Color(253, 205, 68));
        allInButton.setFont(new java.awt.Font("Perpetua Titling MT", 0, 24)); // NOI18N
        allInButton.setText("ALL IN");
        allInButton.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        allInButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                allInButtonActionPerformed(evt);
            }
        });
        panel.add(allInButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 600, 160, 40));
        ...
        doubleButton.setPreferredSize(new java.awt.Dimension(163, 35));
        doubleButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                doubleButtonActionPerformed(evt);
            }
        });
        panel.add(doubleButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 710, 190, 40));
    ...
    public void clearUp() {
        ...
        if (player.getBalance() < 5) {
            ...
            if (choice == JOptionPane.NO_OPTION) {
                BlackjackUI menu = new BlackjackUI();
                menu.pack();
    ...
    private void betButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_betButtonActionPerformed
        ...
        if (betAmount.getText().matches("[0-9]+")) {
            ...
            // If player can afford the bet
                ...
                // Enable double button only if the player can afford it
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (dealer.getHandValue() == player.getHandValue()) {
                                JOptionPane.showMessageDialog(null, "Blackjack push!", "Tie!!", JOptionPane.PLAIN_MESSAGE);
                            } else {
                                ImageIcon win = new javax.swing.ImageIcon(getClass().getResource("/resources/winImg.jpg"));
                                JOptionPane.showMessageDialog(null, null, "Blackjack!", JOptionPane.PLAIN_MESSAGE, win);
                                player.blackjack();
                            }
                            clearUp();
                        }
    ...
    private void standButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_standButtonActionPerformed
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (dealer.getHandValue() > 21) {
                ImageIcon win = new javax.swing.ImageIcon(getClass().getResource("/resources/winImg.jpg"));
                JOptionPane.showMessageDialog(null, null, "Dealer busted!", JOptionPane.PLAIN_MESSAGE, win);
                player.win();
            } 
            // If not, compare hands
                ...
                if (dealer.getHandValue() > player.getHandValue()) {
                    ...
                    JOptionPane.showMessageDialog(null, "With " + player.getHandValue() + " against " + dealer.getHandValue() + "!", "Push!", JOptionPane.PLAIN_MESSAGE);
                } else {
                    ImageIcon win = new javax.swing.ImageIcon(getClass().getResource("/resources/winImg.jpg"));
                    JOptionPane.showMessageDialog(null, null, "You won!", JOptionPane.PLAIN_MESSAGE, win);
                    player.win();
                }
            }
            clearUp();
    ...
    private void allInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_allInButtonActionPerformed
        player.setCurrentBet((int)player.getBalance());
        betAmount.setText(player.getBalance() + "");
        ...
        // Enable gameplay buttons except double
        hitButton.setEnabled(true);
        standButton.setEnabled(true);
        surrenderButton.setEnabled(true);
